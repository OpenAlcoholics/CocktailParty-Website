defmodule OpencocktailBackendWeb.CocktailControllerTest do
  use OpencocktailBackendWeb.ConnCase
  ...
  def fixture(:cocktail) do
    {:ok, cocktail} = Cocktails.create_cocktail(@create_attrs)
    cocktail
  end
